...
func newImageBuildOptions(ctx context.Context, r *http.Request) (*types.ImageBuildOptions, error) {
	...
	options.CredentialSpec = r.FormValue("credentialspec")
	...
	if runtime.GOOS != "windows" && options.CredentialSpec != "" {
		return nil, fmt.Errorf("the daemon on this platform does not support --credentialspec")
	}
