...
#temp fork for pr
clone git github.com/docker/libnetwork v0.7.0-dev.5-hookfix https://github.com/tonistiigi/libnetwork.git
...
clone git github.com/opencontainers/specs a1e32a8ead2ba57adce3e36e956b4dc32c1b85c4 # specs
